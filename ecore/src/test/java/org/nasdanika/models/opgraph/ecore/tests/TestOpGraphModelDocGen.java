package org.nasdanika.models.opgraph.ecore.tests;
...
import org.nasdanika.models.opgraph.ecore.EcoreGenOpGraphProcessorsFactory;
 ...
 *
 */
public class TestOpGraphModelDocGen {
	
	@Test
	public void testGenerateOpGraphModelDoc() throws IOException, DiagnosticException {
		ProgressMonitor progressMonitor = new NullProgressMonitor(); // new PrintStreamProgressMonitor();
		MutableContext context = Context.EMPTY_CONTEXT.fork();
		Consumer<Diagnostic> diagnosticConsumer = d -> d.dump(System.out, 0);
		List<Function<URI,Action>> actionProviders = new ArrayList<>();		
		EcoreGenOpGraphProcessorsFactory ecoreGenFamilyProcessorFactory = new EcoreGenOpGraphProcessorsFactory(context);		
		...
		File output = new File(actionModelsDir, "op-graph.xmi");
		...
		String siteMapDomain = "https://op-graph.models.nasdanika.org";		
